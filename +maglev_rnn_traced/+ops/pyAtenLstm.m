function varargout = pyAtenLstm(varargin)
% Function for the PyTorch operator named aten::lstm.
%
% You must implement this function because the PyTorch importer was unable
% to generate MATLAB code corresponding to the aten::lstm PyTorch
% operator.
%
...
%    Designer.
% 2) Look up the aten::lstm PyTorch operator in the PyTorch
...
error(message('nnet_cnn_pytorchconverter:pytorchconverter:PlaceholderFunction', 'pyAtenLstm'));
